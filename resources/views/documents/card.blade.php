<div class="card mt-3">
  <div class="card-body d-flex flex-row">
    ...
    <div>
      ...
      <div class="font-weight-lighter">{{ $document->created_at->format('Y/m/d H:i') }}</div>
    </div>
      ...
      <div class="ml-auto card-text">
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            ...
            <a class="dropdown-item text-danger" data-toggle="modal" data-target="#modal-delete-{{ $document->id }}">
